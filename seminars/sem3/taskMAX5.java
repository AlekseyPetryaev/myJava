...
методом sort() и вывести его на экран, и отсортировать по возростанию.
*/
...
public class taskMAX5 {
    ...
    static void sort(List<Integer> list) {
        Collections.sort(list); // сортируем список по возростанию
    }
}

/*Ответ
[4, 8, 7, 10, 6, 7, 4, 7, 7, 9]
[4, 4, 6, 7, 7, 7, 7, 8, 9, 10]
*/
